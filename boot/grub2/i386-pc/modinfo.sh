...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 4.8.2 20140120 (Red Hat 4.8.2-16)'
...
grub_target_cppflags=' -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/4.8.2/include'
